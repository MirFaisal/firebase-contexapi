...
const Register = () => {
  ...
  // consiume context method via contextAPI
  const {
    createUserwithEmail,
  ...
  // handel confirm password on change
              ...
              <div className="max-w-xl lg:max-w-3xl">
                ...
                >
                  ...
                  <div className="col-span-6 sm:col-span-3">
                    ...
                    <input
                      onChange={() => handelFirstName(event)}
                      type="text"
                      id="FirstName"
                      name="first_name"
                  ...
                  <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                    ...
                    <p className="mt-4 text-sm text-gray-500 sm:mt-0">
                      ...
                      <Link href="/singin" className="text-gray-700 underline">
                        Log in
                      </Link>
                      .
                    </p>
